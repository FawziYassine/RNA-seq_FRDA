...
Omaveloxolone (RTA 408) is a pharmaceutical compound being tested in the MOXIe clinical trial (NCT02255435) targeting FRDA patients. Omaveloxolone promotes the cellular antioxidative potential through the activation of Nrf2 (Reisman et al., 2019). Omaveloxolone is the most advanced FRDA research therapeutic candidate for FRDA as shown in Friedreich’s Ataxia Treatment Pipeline which is a visual tool for communicating the progress of research and development on lead therapeutic candidates for FRDA. Another potent Nrf2 activator is the natural pharmacological compound **SFN** which is a phytochemical found in Broccoli sprouts.
